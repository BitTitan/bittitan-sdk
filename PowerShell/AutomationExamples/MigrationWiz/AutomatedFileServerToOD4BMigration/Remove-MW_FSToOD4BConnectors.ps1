...
.DESCRIPTION
    This script will remove all MigrationWiz projects created by Migrate-MW_AzureBlobContainerToOD4B.ps1 under a MSPC Customer.
...
#delete connectors
Remove-MW_Connectors -CustomerOrganizationId $customerOrganizationId -ProjectType "Storage" -ProjectName "FS-OD4B-"
