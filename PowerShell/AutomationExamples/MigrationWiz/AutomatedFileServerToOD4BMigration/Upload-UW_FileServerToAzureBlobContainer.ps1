...
.DESCRIPTION
    This script will download and launch the UpoaderWiz agent from the BitTitan server, will create an Azure blob container 
...
#Run the UplaodWiz command wuth with parameters
Write-Host
