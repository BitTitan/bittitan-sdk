...
.DESCRIPTION
    This script will remove all MigrationWiz projects created by Create-MW_Office365Groups.ps1 under a MSPC Customer.
...
#Log file
$logFileName = "$(Get-Date -Format yyyyMMdd)_Remove-MSPC_Endpoints.log"
...
#delete endpoints
Remove-MW_Connectors -CustomerOrganizationId $customerOrganizationId -ProjectType "Mailbox" -ProjectName "Mailbox-O365 Groups conversations"
Remove-MW_Connectors -CustomerOrganizationId $customerOrganizationId -ProjectType "Storage" -ProjectName "Document-"
