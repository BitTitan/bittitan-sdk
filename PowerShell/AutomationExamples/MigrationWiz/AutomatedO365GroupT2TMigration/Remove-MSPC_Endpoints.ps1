...
.DESCRIPTION
    This script will remove all MSPC endpoints created by Create-MW_Office365Groups.ps1 under a MSPC Customer.
...
#delete endpoints
Remove-MSPC_Endpoints -CustomerOrganizationId $customerOrganizationId -EndpointType "Office365Groups" 
