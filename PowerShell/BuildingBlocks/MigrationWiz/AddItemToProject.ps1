...
$mailbox = Add-MW_Mailbox -Ticket $mwTicket -ConnectorId $connector.Id `
	-ImportEmailAddress import@email.com -ExportEmail export@email.com -ExportPassword exportPassword -ImportPassword importPassword `
	-ExportUserName export@email.com -ImportUserName import@email.com
